 ...
 */
export async function sendRegistrationEmail(userEmail, userName, bankUserId, password, role) {
  try {
    ...
    const mailOptions = {
      ...
      text: `Hello ${userName},\n\nWelcome to CyberVault Bank! Your ${role} account has been successfully created.\n\nHere are your login credentials:\nBank ID: ${bankUserId}\nTemporary Password: ${password}\n\nPlease log in and change your password immediately.\n\nBest regards,\nThe CyberVault Team`,
      html: `
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; border: 1px solid #ddd; border-radius: 8px; overflow: hidden;">
          ...
          <div style="padding: 20px;">
            ...
            <p>Your <strong>${roleTitle}</strong> account has been successfully created.</p>
